#!/bin/bash
#SBATCH --job-name=yupu-synthetic
...
#SBATCH --qos=gpu1-32h
#SBATCH --output=/scratch/jacobyoo/logs/yupu_synthetic_%j.log
...
apptainer exec --nv \
    ...
    -c /scratch/jacobyoo/LiDiff/lidiff/config/yupu_normal_synthetic_config.yaml
