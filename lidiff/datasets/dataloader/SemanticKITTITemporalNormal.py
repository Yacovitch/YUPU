...
from lidiff.utils.collations import point_set_to_sparse_normal
...
class TemporalKITTISetNormal(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # partial pcd size based on upsample ratio
        n_part = int(self.num_points / self.upsample_ratio)
        
        return point_set_to_sparse_normal(
            p_full,
            p_part,
            self.num_points,
            n_part,
