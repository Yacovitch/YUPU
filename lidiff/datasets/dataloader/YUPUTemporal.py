...
from lidiff.utils.collations import point_set_to_sparse_grid, point_set_to_sparse_yupu
...
class TemporalYUPUSet(Dataset):
    def __init__(self, data_dir, seqs, split, resolution, num_points, upsample_ratio, max_range, dataset_norm=False, std_axis_norm=False, grid=False):
        super().__init__()
    ...
    def __getitem__(self, index):
        ...
        # Partial size target from config: num_points / upsample_ratio (keep consistent with training)
        ...
        return point_set_to_sparse_yupu(
            p_full,
            p_part,
            self.num_points,
            n_part,
