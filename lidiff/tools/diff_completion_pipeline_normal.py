...
@click.command()
@click.option('--diff', '-d', type=str, default='/nas2/jacob/LiDiff_HPC/experiments/yupu_normal_fusion/default/version_5/checkpoints/yupu_normal_fusion_epoch=19.ckpt', help='path to the scan sequence')
...
def main(diff, refine, denoising_steps, cond_weight, save_reverse_diffusion):
    ...
    exp_dir = 'yupu_low_res_frozen_normal_cross_fusion_yupu2'
