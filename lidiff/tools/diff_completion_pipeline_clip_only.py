...
@click.command()
@click.option('--diff', '-d', type=str, default='/nas2/jacob/LiDiff_HPC/experiments/yupu_clip_only/default/version_2/checkpoints/yupu_clip_only_epoch=19.ckpt', help='path to the scan sequence')
