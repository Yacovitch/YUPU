...
@click.command()
@click.option('--diff', '-d', type=str, default='/nas2/jacob/LiDiff_HPC/experiments/yupu_lidiff_clip_highres/default/version_0/checkpoints/yupu_lidiff_clip_highres_epoch=19.ckpt', help='path to the scan sequence')
...
def main(diff, refine, denoising_steps, cond_weight, save_reverse_diffusion):
    ...
    exp_dir = 'yupu_high_res_frozen_clip'
