...
@click.option('--config',
              ...
              default=join(dirname(abspath(__file__)),'config/sensat_config.yaml'))
...
def main(config, weights, checkpoint, test):
    ...
    tb_logger = pl_loggers.TensorBoardLogger('/nas2/jacob/LiDiff/lidiff/experiments/'+cfg['experiment']['id'],
